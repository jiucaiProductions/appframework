 ...
 *
 */
public abstract class AbstractBaseService extends BaseService implements PageService, DataService,
        UploadService, DownloadService, BinaryService {
    ...
    @Override
    public String handleRequest(ParameterMapper paramMapper, MultipartHttpServletRequest request) {
