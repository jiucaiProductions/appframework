...
public class BaseFusionChart extends BaseChart {
    ...
    public Integer showExportDialog; // Boolean (0/1) Whether to show the export
                                     // dialog during capture phase. If not, the
                                     // chart starts capturing process without
                                     // the dialog visible.
    public String exportDialogMessage; // String The message to be shown in the
                                       // dialog box. The default is
                                       // "Capturing Data : "
    public String exportDialogColor; // Hex Color Background color of dialog
                                     // box.
    public String exportDialogBorderColor; // Hex Color Border color of dialog
                                           // box.
    public String exportDialogFontColor; // Hex Color Font color to be used for
                                         // text in dialog.
    public String exportDialogPBColor; // Hex Color Color of progress bar in
                                       // dialog.
