...
public class DomainUtil extends BaseUtil {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Level 2 SubDomain: "+
        // DomainUtil.getSubDomain(url, 2));

        System.out.println("--------------------------------");

        System.out.println("nanoTime: " + (System.nanoTime() - start) / 100000 + " ms");
        System.out.println("currentTimeMillis: " + (System.currentTimeMillis() - start2) / 100000
                + " ms");
    ...
    private synchronized static void test() {
        ...
        String[] urls = { "http://www.emar.com.cn", "http:www.jiucai.org", "adwiser.emarbox.com",
                "https://www.emar.com.hk/test/test.htm",
                "thunder:a5.a4.a3.a2.emar.com.cn/index.jsp", "ftp://upload.test-test.org",
                "ftp://username:password@f.jiucai.org:21/upload",
                "ftp://username@upload.jiucai.org/upload", "0:0:0:FFFF:129.144.52.38/index.jsp",
                "http://1080::8:800::::", "https://[2001:db8:85a3:8d3:1319:8a2e:370:7348]:443/",
     ...
     * </pre>
     */
    protected static String[] rootDomains = { ".com.cn", ".net.cn", ".org.cn", ".gov.cn",
            ".edu.cn", ".com.hk", ".net.hk", ".org.hk", ".gov.hk", ".edu.hk", ".com.tw", ".net.tw",
            ".org.tw", ".gov.tw", ".edu.tw", ".com", ".net", ".org", ".edu", ".cn", ".hk", ".tw",
            ".biz", ".info", ".mobi", ".name", ".sh", ".ac", ".travel", ".tm", ".us", ".cc", ".mn",
            ".asia", ".ws", ".tel", ".cm" };
     ...
     * </pre>
     */
    protected static String[] protocols = { "http", "https", "ftp", "svn", "udp", "thunder",
            "flashget", "ed2k", "ssh" };
}
